...
```{r child='rxode2/man/rmdhunks/rxode2-cmt-assign.Rmd'}
```
...
```{r child='rxode2/man/rmdhunks/rxode2-cmt-preassign-1.Rmd'}
```

### Appending compartments to the model with `cmt()`

```{r child='rxode2/man/rmdhunks/rxode2-cmt-preassign-2.Rmd'}
```
